...
void EditFrame::InitTextDrawer(TextDrawerWICBitmap& _initDrawer, const ChVec2& _textureSize, const float _fontSize, bool _boldFlg)
{
	...
	_initDrawer.format = _initDrawer.drawer.CreateTextFormat(L"ゴシック",nullptr, _boldFlg ? DWRITE_FONT_WEIGHT_BOLD : DWRITE_FONT_WEIGHT_NORMAL,DWRITE_FONT_STYLE_NORMAL,DWRITE_FONT_STRETCH_NORMAL,_fontSize);
}
