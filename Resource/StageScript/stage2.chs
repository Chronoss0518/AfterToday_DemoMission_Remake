...
Message 作戦開始。\n目標は、あの金色の機体だ。 --messenger operator --addFrame 0.1 --afterFrame 3.0 --stop --endDrawKeyFlg
Message 相手は防御重視の機体だ。\nできる限り相手の攻撃を避けてこちらの攻撃を当てていけ。 --messenger operator --addFrame 0.1 --afterFrame 3.0 --stop --endDrawKeyFlg
